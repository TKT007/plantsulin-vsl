...
// Save sessid2 cookie
document.cookie = "sessid2="+escape("sessid20250614010646929")+";expires="+spiexpire.toGMTString()+";path=/;domain=."+hostname;

// Save funnel cookies
document.cookie = "spi_funnel_codename="+escape("")+";expires="+spiexpire.toGMTString()+";path=/;domain=."+hostname;
			                
					document.cookie = "aff_id="+escape("25058")+";expires="+spiexpire.toGMTString()+";path=/;domain="+hostname;
					
					document.cookie = "sid="+escape("5703|6489_sessid2025061314428659")+";expires="+spiexpire.toGMTString()+";path=/;domain="+hostname;
					
					document.cookie = "campaign_id="+escape("")+";expires="+spiexpire.toGMTString()+";path=/;domain="+hostname;
					
document.cookie = "referrer="+("2a00:b703:fff1:102::1::goplantsulin.org%2Fvideo")+";expires="+spiexpire.toGMTString()+";path=/;domain="+hostname;
...
var spi_replace_str_bg = spi_pattern_base_bg+"sessid2="+escape("sessid20250614010646929")+"&";
...
var spi_replace_str_bg_html = spi_pattern_base_bg_html+"sessid2="+escape("sessid20250614010646929")+"&";
...
var spi_replace_str_bg_html2 = spi_pattern_base_bg_html2+"sessid2="+escape("sessid20250614010646929")+"&";

var spi_pattern_enc_spi = "softwareprojects.com%2Fsecure%2F%3F";
var spi_pattern_base_spi = "softwareprojects.com/secure/?";
var spi_replace_str_spi = spi_pattern_base_spi+"sessid2="+escape("sessid20250614010646929")+"&";

var spi_pattern_enc_cbd = "buygoodshomeoils.com%2Fsecure%2F%3F";
var spi_pattern_base_cbd = "buygoodshomeoils.com/secure/?";
var spi_replace_str_cbd = spi_pattern_base_cbd+"sessid2="+escape("sessid20250614010646929")+"&";
...
var spi_replace_str_cbd_html = spi_pattern_base_cbd_html+"sessid2="+escape("sessid20250614010646929")+"&";
			

spi_replace_str_cbd = spi_replace_str_cbd+'aff_id=25058&sid=5703&sid2=6489_sessid2025061314428659&';spi_replace_str_cbd_html = spi_replace_str_cbd_html+'aff_id=25058&sid=5703&sid2=6489_sessid2025061314428659&';spi_replace_str_bg = spi_replace_str_bg+'aff_id=25058&sid=5703&sid2=6489_sessid2025061314428659&';spi_replace_str_spi = spi_replace_str_spi+'aff_id=25058&sid=5703&sid2=6489_sessid2025061314428659&';spi_replace_str_bg_html = spi_replace_str_bg_html+'aff_id=25058&sid=5703&sid2=6489_sessid2025061314428659&';spi_replace_str_bg_html2 = spi_replace_str_bg_html2+'aff_id=25058&sid=5703&sid2=6489_sessid2025061314428659&';
