        ...
        if (data.length > elementIndex) {
            ...
            if (notificationElement) {
                var htmlContent = '<div class="custom-notification">' +
                    ...
                    '<img src="lib/img/prod@2x.png" alt="" class="middle-back-image"><img src="lib/img/prod@2x.png" alt="" class="left-back-image"><img src="lib/img/prod@2x.png" alt="" class="right-back-image">' +
                    '<img src="lib/img/prod@2x.png" alt="" class="left-front-image"><img src="lib/img/prod@2x.png" alt="" class="right-front-image"><img src="lib/img/prod@2x.png" alt="" class="middle-front-image">' +
                    '</div>' +
